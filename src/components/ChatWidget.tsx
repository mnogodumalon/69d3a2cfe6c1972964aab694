...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {chatOpen && (
        <div className="fixed z-50 left-3 right-3 bottom-[4.5rem] top-[50%] sm:inset-auto sm:bottom-20 sm:right-5 sm:w-[480px] sm:h-[640px] bg-card border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden">
          {/* Header */}
